...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Strong Tower Tutoring Service</title>
		<meta name="description" content="Strong Tower Tutoring Service">
		...
		<!-- Bootstrap core CSS -->
		<link href="{{ asset('css/Worthy/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">

		<!-- Font Awesome CSS -->
		<link href="{{ asset('css/Worthy/fonts/font-awesome/css/font-awesome.css') }}" rel="stylesheet">

		<!-- Plugins -->
		<link href="{{ asset('css/Worthy/css/animations.css') }}" rel="stylesheet">

		<!-- Worthy core CSS file -->
		<link href="{{ asset('css/Worthy/css/style.css') }}" rel="stylesheet">

		<!-- Custom css --> 
		<link href="{{ asset('css/Worthy/css/custom.css') }}" rel="stylesheet">
	</head>
	...
	<body class="no-trans">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="logo smooth-scroll">
								<a href="#banner"><img id="logo" src="images/logo.png" alt="STTS"></a>
							</div>

							<!-- name-and-slogan -->
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="#banner">Strong Tower Tutoring Services</a></div>
								<div class="site-slogan">Cathleen A. Arnold</div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 object-non-visible" data-animation-effect="fadeIn">
							<h1 class="text-center">We are <span>Strong Tower Tutoring Services</span></h1>
		...
		<div class="section clearfix object-non-visible" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">About <span>String Tower</span></h1>
